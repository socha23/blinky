    ...
    componentDidMount() {
        ...
        if (this.props.change || this.props.handleChange) {
            this.mySlider.on("change", e => {
                ...
                // bind to props should be here, not before event handler, because we want to call current prop value
                const changeEvent = that.props.change || that.props.handleChange;
